...
class Pipeline:
    ...
    def backup(self, backup_type: str = "Manual") -> bool:
        ...
        logger.info("Files compressed into: (%s) from (%s)", zip_path, self.src_dir)
        return True

    def restore(self, zip_name: str, target_dir: str = None) -> bool:
